	    ...
	    public function __construct(\stdClass $subscriber_response = NULL, $time_zone = NULL)
	    {
	        if (isset($subscriber_response))
	        {
	            $this
	                ...
	                ->setFirstName(WhatCounts::existsOrNull($subscriber_response, 'firstName'))
	                ->setLastName(WhatCounts::existsOrNull($subscriber_response, 'lastName'))
	                ->setCompany(WhatCounts::existsOrNull($subscriber_response, 'company'))
	                ->setAddress1(WhatCounts::existsOrNull($subscriber_response, 'address1'))
	                ->setAddress2(WhatCounts::existsOrNull($subscriber_response, 'address2'))
	                ->setCity(WhatCounts::existsOrNull($subscriber_response, 'city'))
	                ->setState(WhatCounts::existsOrNull($subscriber_response, 'state'))
	                ->setZip(WhatCounts::existsOrNull($subscriber_response, 'zip'))
	                ->setCountry(WhatCounts::existsOrNull($subscriber_response, 'country'))
