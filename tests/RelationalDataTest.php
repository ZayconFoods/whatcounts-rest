<?php
	...
	class RelationalDataTest extends WhatCountsTest
	{
		...
		public function testGetRelationalData()
		{
			...
			$this->relational_data = $whatcounts->getRelationalData($this->relational_table_name, 22232);
		...
		public function testCreateRelationalData()
		{
			...
			$this->relational_data = $whatcounts->createRelationalData($this->relational_table_name, $relational_data);
